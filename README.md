...
of SHA'S Co. for Water Services Ltd. (a Miahona Company, formerly a Nestlé
Waters JV) and General Manager of Tahaluf Co. (NWC Official Contractor).
...
English-only site. There is no language switcher.

## Contact form

The Strategic Advisory inquiry form sends through Web3Forms. If inquiries
aren't arriving by email, the access key in the source project's
`ContactSection.tsx` likely still needs to be set — see the source
project's README for setup steps.
